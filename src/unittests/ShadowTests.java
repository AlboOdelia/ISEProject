...
public class ShadowTests {
    ...
    private Camera camera = new Camera.BuilderCamera(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)).build() //
    ...
    public void sphereTriangleInitial() {
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereTriangleInitialSS", 400, 400)) //
                .setCamera(camera) //
    ...
    public void trianglesSphere() {
        ...
        Render render = new Render() //
                .setImageWriter(new ImageWriter("shadowTrianglesSphereSS", 600, 600)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
    ...
    public void sphereTriangleMoveTriangle2() {
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereTriangleMoveTriangle2SS", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
    ...
    public void sphereTriangleMoveSphere1() {
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereTriangleMoveSphere1SS", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
    ...
    public void sphereTriangleMoveSphere2() {
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereTriangleMoveSphere2SS", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
