...
public class LightsTests {
    ...
    private Camera camera1 = new Camera.BuilderCamera(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)).build() //
            .setViewPlaneSize(150, 150) //
            .setDistance(1000);
    private Camera camera2 = new Camera.BuilderCamera(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)).build() //
    ...
    /**
     * Produce a picture of a sphere lighted by all kinds of lights
     */
    @Test
    public void sphereAllLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(new Color(0, 300, 0), new Point3D(-50, -50, 50), 1,
    ...
    /**
     * Produce a picture of a two triangles lighted by all kinds of lights
     */
    @Test
    public void trianglesAllLights() {
        scene2.geometries.add(triangle1.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(300)),
                triangle2.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(300)));
        scene2.lights.add(new SpotLight(new Color(500, 250, 250), new Point3D(100, -100, -13),  1,
