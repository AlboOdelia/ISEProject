...
//import XMLoperationBonus.ReadXML;
import elements.*;
import geometries.*;
import primitives.*;
import renderer.*;
...
public class RenderTests {
    private Camera camera = new Camera.BuilderCamera(Point3D.ZERO, new Vector(0, 0, -1), new Vector(0, 1, 0)).build() //
            .setDistance(100) //
...
//        Scene scene = ReadXML.buildSceneFromXML("XML Test scene", "basicRenderTestTwoColors.xml");
