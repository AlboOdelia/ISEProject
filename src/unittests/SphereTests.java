...
public class SphereTests {
    ...
    public void testGetNormal() {
        ...
        assertEquals(vector, sphere.getNormal(new Point3D(1, 0, 0)));
        // TC02: There is a simple test here
...
//        List<Intersectable.GeoPoint> result = sphere.findGeoIntersections(new Ray(new Point3D(-1, 0, 0),
//                new Vector(3, 1, 0)));
...
//            result = List.of(result.get(1), result.get(0));
//        assertEquals("Ray crosses sphere before it and through center", List.of(pZero, p6), result);
//
//        // TC08: Ray starts at sphere and goes inside (1 points)
//        result = sphere.findGeoIntersections(new Ray(new Point3D(0,0,0),
//                new Vector(1,0,0)));
//        assertEquals("Wrong number of points", 1, result.size());
//        assertEquals("Ray crosses sphere, starts at it and goes through center", List.of(p6), result);
//
//        // TC09: Ray starts inside (1 points)
//        result = sphere.findGeoIntersections(new Ray(new Point3D(0.5,0,0),
//                new Vector(1,0,0)));
//        assertEquals("Wrong number of points", 1, result.size());
//        assertEquals("Ray crosses sphere, starts inside it and goes through center", List.of(p6), result);
//
//        // TC10: Ray starts at the center (1 points)
//        result = sphere.findGeoIntersections(new Ray(new Point3D(1,0,0),
//                new Vector(-1,0,0)));
//        assertEquals("Wrong number of points", 1, result.size());
//        assertEquals("Ray crosses sphere, starts at center", List.of(pZero), result);
//
